...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var TaskNewModelDirective, exports;
  TaskNewModelDirective = (function(_super) {
    __extends(TaskNewModelDirective, _super);

    function TaskNewModelDirective($timeout, $window, $compile, $routeParams, commonService) {
      this.show = __bind(this.show, this);
      this.id = "task-new-model";
      TaskNewModelDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
    ...
    TaskNewModelDirective.prototype.setScope = function() {};

    TaskNewModelDirective.prototype.setCSS = function() {
      return css;
    };

    TaskNewModelDirective.prototype.setTemplate = function() {
      return view;
    };

    TaskNewModelDirective.prototype.show = function(scope, element, attrs) {
      var endNodeImage, endNodeImage2, getCurrentNode, getData, nodeImage, nodeImage2, severityMap, timeTranform, updateData, updateWorkLine, x, _i, _len, _ref, _ref1, _ref2;
      severityMap = {};
      ...
      scope.detailType = 1;
      scope.modal = M.Modal.getInstance($("#task-detail"));
      scope.handle = false;
          ...
          if (node != null ? node.node : void 0) {
            ...
            return scope.saveTask(function(taskData) {
              ...
              return _this.taskService.postData(url, data, function(err, result) {
                if (result) {
                  _this.display("操作成功", 500);
                  _this.commonService.publishEventBus("task-model", {
                    open: false
                  });
                  return _this.commonService.publishEventBus("task-query", "reload");
                } else {
                  _this.display("操作失败", 500);
                  _this.commonService.publishEventBus("task-model", {
                    open: false
                  });
                  return _this.commonService.publishEventBus("task-query", "reload");
      ...
      scope.acceptTask = (function(_this) {
        return function() {
          var data, node, schema, url;
          schema = _this.taskService.url;
          url = _this.taskService.replaceUrlParam(schema, scope.task, true);
          node = scope.selectNode;
      ...
      scope.subModel = this.commonService.subscribeEventBus("task-model", (function(_this) {
        return function(msg) {
          ...
          } else if (typeof ((_ref2 = msg.message) != null ? _ref2.task : void 0) === "object") {
            return updateData(msg.message);
          }
        };
      })(this));
      if ((_ref2 = scope.fileSubscribe) != null) {
        _ref2.dispose();
      }
      return scope.fileSubscribe = this.commonService.subscribeEventBus("file", (function(_this) {
        return function(msg) {
          if (!(msg != null ? msg.message : void 0)) {
            return;
          }
          scope.addModel = {
            ...
            url: "/resource/upload/" + msg.message.path
          };
          return scope.$applyAsync();
        };
      })(this));
    ...
    TaskNewModelDirective.prototype.getStatusName = function(phase) {
    ...
    TaskNewModelDirective.prototype.resize = function(scope) {};

    TaskNewModelDirective.prototype.dispose = function(scope) {
    ...
    return TaskNewModelDirective;

  })(base.BaseDirective);
  return exports = {
    TaskNewModelDirective: TaskNewModelDirective
  };
});
