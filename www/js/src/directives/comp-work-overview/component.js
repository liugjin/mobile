...
/*
* File: comp-work-overview-directive
* User: James
* Date: 2019/12/25
* Desc:
 */
...
define(['../base-directive', 'text!./style.css', 'text!./view.html', 'underscore', "moment"], function(base, css, view, _, moment) {
  var CompWorkOverviewDirective, exports;
  CompWorkOverviewDirective = (function(_super) {
    __extends(CompWorkOverviewDirective, _super);

    function CompWorkOverviewDirective($timeout, $window, $compile, $routeParams, commonService) {
      ...
      this.id = "comp-work-overview";
      CompWorkOverviewDirective.__super__.constructor.call(this, $timeout, $window, $compile, $routeParams, commonService);
      this.processtypesService = commonService.modelEngine.modelManager.getService("processtypes");
    }

    CompWorkOverviewDirective.prototype.setScope = function() {};

    CompWorkOverviewDirective.prototype.setCSS = function() {
      return css;
    };

    CompWorkOverviewDirective.prototype.setTemplate = function() {
      return view;
    };

    CompWorkOverviewDirective.prototype.show = function(scope, element, attrs) {
      var typeFilter, update, updateLazy, _ref;
      scope.type = "day";
      scope.typeList = [
        {
          name: '日',
      ...
      scope.cardShow = {};
      typeFilter = scope.project.getIds();
      this.processtypesService.query(typeFilter, null, (function(_this) {
        return function(err, datas) {
          ...
          for (_i = 0, _len = datas.length; _i < _len; _i++) {
            data = datas[_i];
            scope.cardShow[data.type] = data.visible;
          }
    ...
    CompWorkOverviewDirective.prototype.getDateArr = function(scope) {
    ...
    CompWorkOverviewDirective.prototype.getTaskStatus = function(phase) {
      var status;
      status = 0;
    ...
    CompWorkOverviewDirective.prototype.getTaskCount = function(scope) {
    ...
    CompWorkOverviewDirective.prototype.getEquipCheckCounts = function(scope) {
      var aggregateCons, execCount, filter, formatTypeMap, formatTypeMap2, groupObj, matchObj, type;
      aggregateCons = [];
      matchObj = {};
      groupObj = {};
    ...
    CompWorkOverviewDirective.prototype.getEquipCounts = function(scope) {
    ...
    CompWorkOverviewDirective.prototype.getExcepEquipCounts = function(scope) {
      var aggregateCons, execCount, filter, formatTypeMap, formatTypeMap2, matchObj, type;
      aggregateCons = [];
      matchObj = {};
      type = scope.type;
    ...
    CompWorkOverviewDirective.prototype.getExcepWorkItems = function(scope) {
      var aggregateCons, execCount, filter, formatTypeMap, formatTypeMap2, matchObj, type;
      aggregateCons = [];
      matchObj = {};
      type = scope.type;
    ...
    CompWorkOverviewDirective.prototype.getEquipDefectCounts = function(scope) {
    ...
    CompWorkOverviewDirective.prototype.resize = function(scope) {};

    CompWorkOverviewDirective.prototype.dispose = function(scope) {
      var _ref;
      return (_ref = scope.subTimeType) != null ? _ref.dispose() : void 0;
    };

    return CompWorkOverviewDirective;

  })(base.BaseDirective);
  return exports = {
    CompWorkOverviewDirective: CompWorkOverviewDirective
  };
});
