...
define(['clc.foundation.angular/controllers/controller'], function(base) {
  ...
  Ctrl = (function(_super) {
    ...
    function Ctrl($scope, $rootScope, $routeParams, $location, $window, $state, cloudAuthService, toastService, $timeout, settingService, $ionicActionSheet, storage, $ionicPopover) {
      this.$state = $state;
