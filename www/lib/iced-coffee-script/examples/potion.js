...
var BTree, Person, Policeman, a, add, app, b, block, count, foods, i, key, minus, p, table, val, x, y, _i, _j, _ref,
...
HomePage.prototype.get = function(url) {
  var session, _ref1;
  return session = (_ref1 = url.query) != null ? _ref1.session : void 0;
};
